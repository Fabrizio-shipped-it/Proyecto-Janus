...
BEGIN
    ...
    CREATE TABLE #TempProductos (
        ...
        PrecioCosto VARCHAR(50),
        PrecioReferencia VARCHAR(50),
        Unidad VARCHAR(50),
        FechaRegistro VARCHAR(50)
    );

    -- Importar datos desde el archivo CSV a la tabla temporal
    BULK INSERT #TempProductos
    FROM 'C:\Users\Usuario\Downloads\TP_integrador_Archivos\Productos\catalogo.csv'
    WITH (
		FIELDTERMINATOR = ',',    
        ROWTERMINATOR = '0x0a',     
        FIRSTROW = 1,             
